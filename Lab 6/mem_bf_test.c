/**
  ***********************************************************************************
  * @file   : mem_bf_test.c
  * @brief  : Test file for best fit algorithm
...
int main() {
    ...
    printf("TESTING BEST FIT MEMORY REQUEST\n");
    test = mymalloc_bf(5);

    mem_print_stats();
    printf("Should be: (50-2-6-50)\n");
    mem_print();
    printf("Node Sizes should be: 10, 15, 40, 30, 5 and Node 0, 2 should be free\n");
    printf("---------------------------------------------\n");
